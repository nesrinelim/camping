...
class MyVerticallyCenteredModal extends React.Component {
    render() {
      return (
        ...
        >
          ...
          <Modal.Body style={{ backgroundColor: "rgba(255, 235, 255, 0.8)",opacity:"1.2",color:'black' }}>
            ...
            <select aria-label="Régions" class="form-control" style={{height:"40px",borderRadius:"0",width:"97%",fontFamily:"Poppins",color:"#000000"}}>
      ...
      <h6>Were you able to accomplish what you wanted?</h6>
          <button style={{backgroundColor:'white',border:'1px solid',borderRadius:'3px' ,padding:'2%' }}> <i className='far fa-smile' style={{fontSize:'24px'}}> </i> Yes !</button>  <button style={{backgroundColor:'white',border:'1px solid',borderRadius:'3px' ,padding:'2%' }}> <i className='far fa-frown' style={{fontSize:'24px'}}> </i> No</button>
      <h6>What was your favorite part about your experience today?</h6>
      <input style={{width:'97%'}} placeholder="Was it all the amazing campgrounds we have"/>
      <h6> What was your least favorite?</h6>
      <input style={{width:'97%'}} placeholder="We want to make this right"/> 
      <h6> Anything else you would like to share or get off your chest?</h6>
      <input style={{width:'97%'}} placeholder="Anithing, anything at all"/>
      
          </Modal.Body>
          <Modal.Footer style={{ backgroundColor: "rgba(255, 235, 255, 0.8)",opacity:"1.2",color:'black'}}>
          <button  style={{color:'#f1a404',backgroundColor:'#212121',padding: "1%",paddingRight: "2%",paddingLeft: "2%",width:'100%!important'}}>Submit</button>
